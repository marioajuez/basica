...
// --------------------------------------------
      ...
      if (this.rebuy >= 2000) this.rebuy = 2000;
        this.table.push({
          ...
          date:new Date(this.userData.date).setDate(
            new Date(this.userData.date).getDate() + i+1),
          amount: this.amount,
  ...
  private calculate_(data:dataTable, { rebuyNever= false, initalizeTable = false}= {}){
